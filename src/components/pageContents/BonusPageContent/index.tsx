...
const BonusPageContent: FC = () => {
  ...
  return (
    <>
      <section className="flex flex-col gap-8 max-sm:gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg leading-lg max-sm:text-base max-sm:leading-base">
            Участие в бонусной программе позволяет накапливать и тратить бонусные баллы в заведениях участниках
            программы и онлайн фудмаркете pirogvatrushka.ru, а также получать специальные предложения для участников
            программы.
          </p>
        </div>
        <div className="flex flex-col gap-6 rounded-2xl bg-bgLayout p-6 max-sm:p-4">
          ...
          <Button type="primary" onClick={onOpenAuthModal} className="w-max max-sm:text-base max-sm:leading-base">
            Зарегистрироваться
          </Button>
        </div>
          ...
          <div className="flex flex-col gap-6">
            <Accordion
              ...
              text={
                <div className="flex flex-col gap-4">
                  <p>
                    Начисление бонусов происходит при совершении покупок в кафе и ресторане участников бонусной
                    программы Premium Bonus Club&#42; и на сайте pirogvatrushka.ru в следующем объеме:
                  </p>
            ...
            <Accordion
              ...
              text={
                <ul className="list-bullet space-y-2 pl-4">
                  ...
                  <li className="pl-1">
                    Совершить покупку с процедурой авторизации на сайте «https://pirogvatrushka.ru», заполнив
                    мини-анкету с обязательными полями: фамилия, имя, дата рождения, номер телефона.
                  </li>
                  <li className="pl-1">
              ...
              text={
                <div className="flex flex-col gap-4">
                  ...
                  <ul className="list-bullet space-y-2 pl-4">
                    ...
                    <li className="pl-1">
                      по номеру телефона зарегистрированного участника программы PremiumBonusClub.
                    </li>
                  </ul>
      ...
      <AuthModal isOpen={isAuthModalOpen} setIsOpen={setIsAuthModalOpen} firstStep={AuthModalSteps.SIGN_UP} />
    </>
  );
};
