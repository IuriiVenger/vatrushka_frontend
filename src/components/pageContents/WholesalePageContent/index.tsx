...
export const WholesalePage = () => {
  ...
  const onClick = () => {
    message.info('открывается попап');
  };
  return (
    <div className="flex flex-col gap-8 max-sm:gap-6">
      ...
      <section className="flex flex-col text-lg leading-lg max-sm:text-base max-sm:leading-base">
        ...
        <p className="pt-6 max-sm:gap-4">
          Приглашаем к сотрудничеству кофейни, рестораны, отели, магазины. Предлагаем регулярные поставки полуфабрикатов
          и готовой продукции собственного производства. Для вас выгодные условия, гибкий ассортимент, всегда
