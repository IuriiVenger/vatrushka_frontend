  ...
  return (
    <>
      <footer className="w-full bg-bgLayout text-lg leading-lg max-sm:text-base max-sm:leading-base">
        <div className="mx-auto max-w-300 gap-12 pt-9 max-xl:px-10 max-xs:gap-6 max-xs:px-4">
        ...
        <Divider />
        <div className="mx-auto flex w-full max-w-300 justify-between gap-4 pb-9 max-xl:px-10 max-lg:flex-col-reverse max-lg:items-center max-sm:items-start max-xs:px-4">
